...
The package includes a customizable spatially explicit demographic population model 
simulation engine, which incorporates default functionality for density dependence, 
correlated environmental stochasiticity, stage-based transitions, and distance-based 
dispersal. The user may also define functionality for translocations, harvesting, 
mortality, and other processes, as well as define the sequence order for the 
