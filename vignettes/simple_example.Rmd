...
The generator utilizes generic templating functionality for user-defined custom
...
attributes, or alternatively direct access to an attribure may be defined via a string.
...
We now select and analyse our 'best' models via a *Validator* class object, which by
...
diagnostic output (PDF) file, containing statistical information for analysing the 
...
harvest. However, the package facilitates the use more complex spatiotemporal metrics 
...
our more advanced vignettes, and towards utilizing the package for your own modeling 
projects.
