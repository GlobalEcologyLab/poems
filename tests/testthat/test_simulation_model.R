...
test_that("initialization, get and set", {
  ...
  sim_model <- SimulationModel$new(params = list(time_steps = 10, attr1 = list(a = 2)), region = region,
  ...
  expect_equal(sim_model$get_attributes(params = c("coords", "time_steps", "a1_a", "a1_b", "a2")),
...
test_that("template nesting via list", {
  ...
  attribute_aliases <- list(coords = "region$coordinates", a1_a = "attr1$a", a1_b = "attr1$b", a2 = "attr2")
  nested_model <- SimulationModel$new(template = list(time_steps = 10, region = region, attr1 = list(a = 2),
                                                      attr2 = 55),
  ...
  expect_equal(nested_model$get_attributes(params = c("coords", "time_steps", "a1_a", "a1_b", "a2")),
               list(coords = region$coordinates, time_steps = 10, a1_a = 2, a2 = 55))
...
test_that("template nesting via object", {
  ...
  required_attributes <- c("region", "time_steps", "attr1")
  attribute_aliases <- list(coords = "region$coordinates", a1_a = "attr1$a", a1_b = "attr1$b", a2 = "attr2")
  template_model <- SimulationModel$new(time_steps = 10, region = region, model_attributes = model_attributes,
...
test_that("set nested samples", {
  region <- Region$new(coordinates = array(c(1:4, 4:1), c(7, 2)))
  attribute_aliases <- list(coords = "region$coordinates", a1_a = "attr1$a", a1_b = "attr1$b", a2 = "attr2")
  nested_model <- SimulationModel$new(template = SimulationModel$new(time_steps = 10, region = region,
                                                                     attribute_aliases = attribute_aliases,
                                                                     attr1 = list(a = 2), attr2 = 55))
...
test_that("consistency and completeness", {
  ...
  attribute_aliases <- list(coords = "region$coordinates", a1_a = "attr1$a", a1_b = "attr1$b", a2 = "attr2")
  nested_model <- SimulationModel$new(template = SimulationModel$new(), model_attributes = model_attributes,
                                      required_attributes = required_attributes,
                                      attribute_aliases = attribute_aliases)
  expect_equal(nested_model$list_consistency(), list(region = NA, coordinates = NA, time_steps = NA,
                                                     attr1 = NA, attr2 = NA))
  ...
  expect_equal(nested_model$list_completeness(), list(region = FALSE, coordinates = NA, time_steps = FALSE,
  ...
  nested_model$set_attributes(a1_a = array(1:6, c(6, 10)), a1_b = 1:11,
  ...
  nested_model$set_attributes(a1_a = array(1:7, c(7, 9)), a1_b = 1:10,
