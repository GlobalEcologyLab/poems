test_that("initialization and parameter setting", {
  ...
  expect_equal(
    ...
    list(
      param_class = list(type = "class", classes = c("a", "b", "c", "d", "e")),
  ...
  expect_equal(
    lhs_generator$parameter_distributions,
    list(param_lognorm = list(
      type = "lognormal", meanlog = log(10^2 / sqrt(10^2 + 2^2)),
  ...
  expect_error(
    lhs_generator$set_beta_parameter("param_beta", alpha = 0),
  ...
  expect_equal(
    lhs_generator$parameter_distributions,
    list(param_beta = list(
      type = "beta", alpha = 0.5 * (0.5 * (1 - 0.5) / (0.5 * 0.999)^2 - 1),
  ...
  lhs_generator <- LatinHypercubeSampler$new()
  expect_error(
    lhs_generator$set_poisson_parameter("param_pois", lambda = -1),
  ...
  lhs_generator <- LatinHypercubeSampler$new()
  expect_error(
    lhs_generator$set_triangular_parameter("param_triang", lower = 2, upper = 0),
