...
test_that("user-defined transformation", {
  ...
  test_function_1 <- function(params) { # add one to occupied density stages
    ...
    extra_stage_abundance <- extra_stage_abundance*previous_stage_abundance
  ...
  previous_stage_abundance <- +(stage_abundance > 0)
  expected_stage_abundance <- stage_abundance
  expected_stage_abundance[2:3, (1:7)[-5]] <- expected_stage_abundance[2:3, (1:7)[-5]] + 1
  expected_stage_abundance <- expected_stage_abundance*previous_stage_abundance
  ...
  expect_equal(simulator$attached$params[c("a", "b", "r", "tm", "carrying_capacity", "stage_abundance",
                                           "occupied_indices", "previous_stage_abundance")],
               list(a = 1, b = 2, r = 2, tm = 6, carrying_capacity = carrying_capacity,
                    ...
                    previous_stage_abundance = previous_stage_abundance))
